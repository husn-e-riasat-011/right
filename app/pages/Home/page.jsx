      ...
      >
        ...
        <div className=" py-10 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <h2 className=" text-white w-[80%] text-5xl font-semibold leading-tight tracking-wide text-center my-6 mx-auto">
              Navigating the legal landscape is simple with our AI-powered
              platform
            </h2>
            <p className=" text-white mt-4 w-[84%] m-auto text-2xl font-normal leading-8 tracking-wide text-center">
            ...
            <div class="lg:w-3/4 mx-auto mb-6">
              <div className="flex flex-wrap w-full bg-[#2F2F31] border border-[#5E5E5E] rounded-xl py-28 px-28 relative mb-10">
                <Image
                  ...
                  className="absolute left-20 -bottom-5 transform rotate-180"
                />
                <div className="text-center relative z-10 w-full ">
                  <Image
                    ...
                    className="mx-auto"
                  />
                  <p className="font-sans text-lg font-normal leading-6 tracking-wider text-center text-[#CECECE] mt-6">
              ...
              <div class="flex flex-wrap w-full ">
                <div class="pr-4 w-1/2">
                  <div className="text-center  z-10 flex flex-wrap w-full bg-[#2F2F31] border border-[#5E5E5E] rounded-2xl sm:py-18 py-10 sm:px-10 px-6 relative ">
                    <Image
                      src={right}
                      width={40}
                      height={40}
